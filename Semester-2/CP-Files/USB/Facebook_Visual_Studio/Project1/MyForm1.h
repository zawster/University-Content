...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(22, 90);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(220, 45);
			this->label1->TabIndex = 0;
			this->label1->Text = L"NEWS FEED";
			// 
			// button1
			// 
			this->button1->BackColor = System::Drawing::SystemColors::ActiveBorder;
			this->button1->ForeColor = System::Drawing::SystemColors::ActiveCaptionText;
			this->button1->Location = System::Drawing::Point(281, 104);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(110, 27);
			this->button1->TabIndex = 1;
			this->button1->Text = L"Write Post";
			...
			this->button2->Location = System::Drawing::Point(444, 104);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(110, 27);
			this->button2->TabIndex = 2;
			this->button2->Text = L"Messages";
			...
			this->button3->Location = System::Drawing::Point(605, 104);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(110, 27);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(668, 22);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(859, 19);
			...
			this->label2->Location = System::Drawing::Point(67, 9);
			...
			this->ClientSize = System::Drawing::Size(928, 519);
