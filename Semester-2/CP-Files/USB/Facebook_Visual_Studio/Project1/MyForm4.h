...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(817, 29);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(201, 88);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(109, 23);
			this->button2->TabIndex = 1;
			this->button2->Text = L"Write Post";
			this->button2->UseVisualStyleBackColor = true;
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(27, 88);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(364, 88);
			...
			this->label1->Location = System::Drawing::Point(542, 70);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(221, 42);
			this->label1->TabIndex = 4;
			this->label1->Text = L"Notifications";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(624, 32);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 27.75F, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label2->ForeColor = System::Drawing::SystemColors::ButtonHighlight;
			this->label2->Location = System::Drawing::Point(72, 11);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(355, 42);
			...
			this->ClientSize = System::Drawing::Size(914, 521);
