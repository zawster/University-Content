...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Location = System::Drawing::Point(459, 166);
			...
			this->textBox2->Location = System::Drawing::Point(459, 228);
			...
			// dateTimePicker1
			// 
			this->dateTimePicker1->Location = System::Drawing::Point(965, 578);
			...
			this->label1->Location = System::Drawing::Point(405, 36);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(447, 54);
			...
			this->button2->Location = System::Drawing::Point(539, 430);
			...
			this->button3->Location = System::Drawing::Point(1, 572);
			this->button3->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(956, 43);
			...
			this->ClientSize = System::Drawing::Size(1259, 617);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	bool login(string emi, string passi)
	{
		string fuser,fpass;
		ifstream file;
		file.open("user.txt");
		...
		{
			file>>fuser>>fpass;
			//cout<<fuser<<" "<<emi<<" "<<fpass<<" "<<passi<<"      ";
			if(fuser==emi)
			{
				if (fpass==passi)
				{
					MyForm2^ p = gcnew MyForm2;
					p->show();
				}
